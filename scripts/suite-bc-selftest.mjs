...
console.log("\n[2] Outcome classification:");
{
  ...
  assert.equal(outcomeSatisfies("denied", "method_not_allowed"), false, "a method rejection is never a denial");
  assert.equal(isDenial("method_not_allowed"), false, "405 is a nameable answer, and it is not a denial");
  assert.equal(classify({ status: 405 }), "method_not_allowed", "405 must be named, not left unclassified");
